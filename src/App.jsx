...
const TESTIMONIOS = [
  {
    ...
    texto:
      "Empecé mi comiquería con SoraBooks y en seis meses ya tenía más de 80 títulos en stock. La atención es increíble y los tiempos de entrega son exactos. Es el proveedor que estaba buscando.",
  },
  {
    ini: "GR",
    nombre: "Gonzalo Rolo.",
    ...
    texto:
      "Los precios mayoristas son reales, el catálogo siempre está actualizado y mi asesor me avisa cada vez que entra algo nuevo. Escalé mi negocio a otro nivel con SoraBooks.",
  },
  {
    ini: "SV",
    nombre: "Sofía Velez.",
  ...
  return (
    <>
      {/*
        ...
        <meta name="description" content="SoraBooks — Mayorista de mangas para comiquerías, emprendedores y revendedores de todo el país." />
        <meta property="og:title" content="SoraBooks — Accedé a los mangas más buscados" />
      ...
      <div className="min-h-screen overflow-hidden bg-zinc-950 text-zinc-100 scroll-smooth">
          ...
          <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 px-6 pb-20 pt-16 sm:gap-16 sm:pb-24 sm:pt-20 lg:grid-cols-[1fr_1.05fr] lg:gap-24 lg:pb-28 lg:pt-24 xl:gap-32">
            ...
            <div>
              ...
              <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                <a
                  href={WA("Hola! Quiero consultar sobre venta mayorista de mangas en SoraBooks.")}
                  target="_blank"
        ...
        >
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-10 text-center">
              <a
                href={WA("Hola! Quiero ver el catálogo completo de SoraBooks")}
                target="_blank"
                rel="noopener noreferrer"
        ...
        >
          ...
          <div className="relative mx-auto max-w-4xl text-center">
            ...
            <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <a
                href={WA("Hola! Quiero sumarme a SoraBooks y conocer las condiciones mayoristas")}
                target="_blank"
                rel="noopener noreferrer"
        ...
        >
          <div className="mx-auto max-w-4xl">
            ...
            <div className="mt-12 rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8 text-center">
              ...
              <a
                href={WA("Hola! Tengo una consulta sobre SoraBooks")}
                target="_blank"
                rel="noopener noreferrer"
        ...
        <footer className="border-t border-zinc-900 bg-zinc-950 px-6 py-10 text-zinc-300">
          <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 md:flex-row">
            ...
            <div className="text-xs">© 2026 SoraBooks. Todos los derechos reservados.</div>
          </div>
        </footer>

        {/* ── BOTÓN FLOTANTE WHATSAPP (mobile) ────────────────────────────── */}
        <a
          href={WA("Hola! Quiero información sobre SoraBooks")}
          target="_blank"
          rel="noopener noreferrer"
