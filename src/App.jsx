      ...
      <>
        ...
        */}
        ...
        <div className="rounded-[28px] border border-zinc-800 bg-zinc-900/60 p-8">
          ...
          <p className="mt-4 leading-relaxed text-zinc-300">
            Trabajamos con logística para toda Argentina.
          </p>
        </div>
        ...
        <div className="rounded-[28px] border border-zinc-800 bg-zinc-900/60 p-8">
          ...
          <p className="mt-4 leading-relaxed text-zinc-300">
            Nuevos títulos y novedades todas las semanas.
          </p>
        </div>
        ...
        <div className="rounded-[28px] border border-zinc-800 bg-zinc-900/60 p-8">
          ...
          <p className="mt-4 leading-relaxed text-zinc-300">
            Te ayudamos a encontrar lo ideal para tu proyecto.
          </p>
        </div>
          ...
          <section
            id="novedades"
            className="border-b border-zinc-900 bg-[#090909] px-6 py-28"
            style={{ scrollMarginTop: "80px" }}
          >
    ...
    {p.n === "04" && (
      ...
      >
        ...
        />
          ...
          <section
            id="faq"
            className="border-t border-zinc-900 bg-[#090909] px-6 py-28"
            style={{ scrollMarginTop: "80px" }}
          >
